...
public class KakaoPayServiceImpl implements KakaoPayService{
    ...
    public ReadyResponseDTO readytoPay(OrderDTO orderDTO){
         ...
         Long ono = orderService.updateOrder(orderDTO);
...
//                .build();
        ...
        parameters.add("partner_order_id", ono.toString());
        ...
        parameters.add("approval_url",  present_url+ "/approve/"+ ono); // 성공 시 redirect url
        parameters.add("cancel_url",  present_url + "/failtopay"); // 취소 시 redirect url
        parameters.add("fail_url", present_url + "/failtopay"); // 실패 시 redirect url
...
//                .block();
        ...
        paymentRepository.save(new Payment(readyResponseDTO.getTid(),ono.toString()));

        readyResponseDTO.setOno(ono.toString());
